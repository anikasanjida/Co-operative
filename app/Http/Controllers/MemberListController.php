...
class MemberListController extends Controller
{
    ...
    public function deleteMember($id)
    {
        ...
        $user = User::find($members->Memberuser->id);
    ...
    public function store(Request $request)
    {
        ...
        $m_c = m_collect::where('user_id',$request->user_id)->get();
        foreach($m_c as $data){
            if ($data-> month == $request->month) {
                return redirect()->back()->with('error', 'Wait for next month.');
            }
        }
    ...
    public function datastore(Request $request)
    {
        ...
        $m_installment = m_collect::where('user_id',$request->user_id)->get();
        foreach($m_installment as $data){
            if ($data-> month == $request->month) {
                return redirect()->back()->with('error', 'Wait for next month.');
            }
        }
